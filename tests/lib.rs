...
fn tarantool_with_builder() {
    ...
    let test_array = [
        HeterogeneousElement::I8(0),
        HeterogeneousElement::I16(1),
        HeterogeneousElement::I32(2),
        HeterogeneousElement::I64(3),
        HeterogeneousElement::STRING("5"),
    ...
    let test_tuple = (HeterogeneousElement::I8(0),
                      HeterogeneousElement::I16(1),
                      HeterogeneousElement::I32(2),
                      HeterogeneousElement::I64(3),
                      HeterogeneousElement::STRING("5"),
                      ...
                      HeterogeneousElement::U64(-3),
                      HeterogeneousElement::BOOLEAN(true));
    let test_vector = vec![HeterogeneousElement::I8(0),
                           HeterogeneousElement::I16(1),
                           HeterogeneousElement::I32(2),
                           HeterogeneousElement::I64(3),
                           HeterogeneousElement::STRING(Cow::Borrowed("Borrowed string")),
                           HeterogeneousElement::STRING(Cow::Owned("Owned string")),
                           HeterogeneousElement::U8(0),
                           HeterogeneousElement::U16(-1),
                           HeterogeneousElement::U32(-2),
                           HeterogeneousElement::U64(-3),
